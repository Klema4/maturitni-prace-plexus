...
import {
  OverviewChartRow,
  useOverviewChartCard,
} from "../hooks/useOverviewChartCard";
...
function ChartTooltip({ active, payload, label }: CustomTooltipProps) {
  ...
  const rawRow = firstPoint.payload as OverviewChartRow;
  const dateValue =
...
export function OverviewChartCard({
  ...
  const { data, loading, error } = useOverviewChartCard({
    apiUrl,
    valueKey,
    categoryLabel,
  });

  const getValue = (row?: OverviewChartRow) =>
